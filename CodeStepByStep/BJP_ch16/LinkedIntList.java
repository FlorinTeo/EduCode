...
public class LinkedIntList {
    protected ListNode front;   // node holding first value in list (null if empty)
    protected String name = "front";   // string to print for front of list
    ...
    // For quick initialization via internal test cases.
    ...
    // For quick initialization via internal ListNode test cases.
    public LinkedIntList(String name, ListNode front) {
        this.name  = name;
        this.front = front;
    }
