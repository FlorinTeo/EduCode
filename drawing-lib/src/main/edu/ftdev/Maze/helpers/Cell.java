...
public class Cell extends WClass {
    ...
    protected void instantiate() throws Exception {
        _wrapObj = getCtor(pkgFix("public #Cell#(edu.ftdev.Maze.MazeCanvas,int,int)"))
    ...
    public int getRow() {
        return (int)super.invoke(pkgFix("public int #Cell#.getRow()"));
    }
    
    public int getCol() {
        return (int)super.invoke(pkgFix("public int #Cell#.getCol()"));
    }
    
    @SuppressWarnings("unchecked")
    public List<Side> getWalls() {
        return (List<Side>)super.invoke(pkgFix("public java.util.*List #*Cell#.getWalls()"));
    }
    
    public void removeWall(Side side) {
        super.invoke(pkgFix("public void #Cell#.removeWall(edu.ftdev.Maze.MazeCanvas$Side)"), side);
    }
    
    public boolean getVisited() {
        return (boolean)super.invoke(pkgFix("public boolean #Cell#.getVisited()"));
    }
    
    public void setVisited(boolean visited) {
        super.invoke(pkgFix("public void #Cell#.setVisited(boolean)"), visited);
    }
    
    @SuppressWarnings("unchecked")
    public List<Side> getPaths() {
        return (List<Side>)super.invoke(pkgFix("public java.util.*List *.getPaths()"));
    }
