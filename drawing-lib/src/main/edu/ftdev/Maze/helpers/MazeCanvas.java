...
public class MazeCanvas extends edu.ftdev.Maze.MazeCanvas {
    ...
    // DbgControls overrides
    // Disable all DbgControls during tests
    @Override
    public boolean breakStep() { return false; }
    @Override
    public boolean breakStep(long delay) { return false; }
    @Override
    public boolean breakLeap() { return false; }
    @Override
    public boolean breakJump() { return false; }
    // DbgControls overrides 
